...
?><div class="row">
 ...
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_BLOG_URL" => "tests_comments_ps",
		"DETAIL_BLOG_USE" => "Y",
		"DETAIL_BRAND_USE" => "N",
		...
		"SEF_FOLDER" => "/tests/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"compare.php?action=#ACTION_CODE#","element"=>"#ELEMENT_CODE#/","section"=>"","sections"=>"filter/#SMART_FILTER_PATH#/apply/","smart_filter"=>"filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "Y",
