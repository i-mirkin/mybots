...
$APPLICATION->SetTitle("Тесты онлайн");

$APPLICATION->SetPageProperty("title", "Профессиональные тесты онлайн для взрослых и детей, работодателей и соискателей, учеников и студентов");
$APPLICATION->SetPageProperty("description", "Тесты для всех - психологические, для детей, школьников, подростков и взрослых, мужчин и женщин, профессиональные и развлекательные");
...
?>
<div class="row"><div class="col xl10 offset-xl1"><h1 class="pagetitle"><?$APPLICATION->ShowTitle(false);?></h1></div></div>
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_PROPERTY_CODE" => array("PRO","FILTER",""),
		...
		"INSTANT_RELOAD" => "N",
		"LABEL_PROP" => array("FILTER","PRO"),
		"LABEL_PROP_MOBILE" => array("FILTER"),
		...
		"SEF_FOLDER" => "/tests/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"compare.php?action=#ACTION_CODE#","element"=>"#ELEMENT_CODE#/","section"=>"","sections"=>"","smart_filter"=>"filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
